...
male_age_model = load_model('male_age_model.keras')  #  path to your male_age_model
female_age_model = load_model('female_age_model.keras')  #path to your female_age_model
