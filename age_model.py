...
# defining the path of image directory
image_directory = "unsamples"

# Load pictures  data from the folder  and resize them  by sizw into (64, 64)
loaded_images = []
...
# Load age and gender labels from a CSV file (containing the labes of male and female
age_gender_data = pd.read_csv('age_gender.csv')  # Replaced with my  CSV file path
