...
#  MediaPipe Hand module initilization
...
# Initialize the camera (0 is usually the default camera 1 and for the secomdary camera )
...
while True:
    ...
    # Convert the frame to RGB (MediaPipe requires RGB colorful input)
